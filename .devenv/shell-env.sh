...
DEVENV_PROFILE='/nix/store/v223818fhgwzmybccrf91ai7nzlb8fli-devenv-profile'
...
export stdenv
DEVENV_ROOT='/home/renan/projects/assignments/tiqets'
export DEVENV_ROOT
...
prefix='/nix/store/p9k78clh5pgwsasmq9z256yrdpxah2j1-devenv-shell-env'
depsBuildTarget=''
...
defaultBuildInputs=''
PKG_CONFIG_PATH='/nix/store/bvsy09r85z0q1m30p87s1bf4ikb0s84i-bash-interactive-5.3p9-dev/lib/pkgconfig:/nix/store/g4k9vjiwikf7ys8qq15dypn12qwyivxc-python3-3.13.13-env/lib/pkgconfig'
export PKG_CONFIG_PATH
declare -a fixupOutputHooks=('if [ -z "${dontPatchELF-}" ]; then patchELF "$prefix"; fi' 'if [[ -z "${noAuditTmpdir-}" && -e "$prefix" ]]; then auditTmpdir "$prefix"; fi' 'if [ -z "${dontGzipMan-}" ]; then compressManPages "$prefix"; fi' '_moveLib64' '_moveSbin' '_moveSystemdUserUnits' 'patchShebangsAuto' '_pruneLibtoolFiles' '_doStrip' )
NIX_LDFLAGS='-rpath /nix/store/p9k78clh5pgwsasmq9z256yrdpxah2j1-devenv-shell-env/lib  -L/nix/store/g4k9vjiwikf7ys8qq15dypn12qwyivxc-python3-3.13.13-env/lib -L/nix/store/g4k9vjiwikf7ys8qq15dypn12qwyivxc-python3-3.13.13-env/lib'
export NIX_LDFLAGS
shellHook='
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/9ypz3flqsrl5xl495mm8h645gadjsxi1-coreutils-9.11/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/v223818fhgwzmybccrf91ai7nzlb8fli-devenv-profile" ]
then
  ln -snf /nix/store/v223818fhgwzmybccrf91ai7nzlb8fli-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
mkdir -p /run/user/1000/devenv-0acc681
ln -snf /run/user/1000/devenv-0acc681 /home/renan/projects/assignments/tiqets/.devenv/run
...
{
  if [[ ":${DIRENV_ACTIVE-}:" == *":/home/renan/projects/assignments/tiqets:"* ]]; then
...
AR='ar'
export AR
PYTHONPATH='/nix/store/q442hspcjdf6h45d15pcn1ayy2ll1l8j-sitecustomize.py'
export PYTHONPATH
UV_PROJECT_ENVIRONMENT='/home/renan/projects/assignments/tiqets/.devenv/state/venv'
export UV_PROJECT_ENVIRONMENT
dontAddPythonPath='1'
export dontAddPythonPath
declare -a envBuildHostHooks=()
outputDevdoc='REMOVE'
DEVENV_STATE='/home/renan/projects/assignments/tiqets/.devenv/state'
export DEVENV_STATE
MACHTYPE='x86_64-pc-linux-gnu'
AS='as'
export AS
nativeBuildInputs='/nix/store/bvsy09r85z0q1m30p87s1bf4ikb0s84i-bash-interactive-5.3p9-dev /nix/store/g4k9vjiwikf7ys8qq15dypn12qwyivxc-python3-3.13.13-env /nix/store/hq1ygvwk5p6w6iyvfqfpvxbwjvi1b2cw-uv-0.11.16 /nix/store/1bs97v1qsgd1vmjn0k9cl9qkxq04ngzp-pyright-1.1.410 /nix/store/1m05k7xgfnw6jc21xxk5681ni3ar97wf-pkg-config-wrapper-0.29.2'
...
XDG_DATA_DIRS='/nix/store/cgjr3kj3hs7ngznyws5qfg16c8scpys0-bash-interactive-5.3p9/share:/nix/store/g4k9vjiwikf7ys8qq15dypn12qwyivxc-python3-3.13.13-env/share:/nix/store/hq1ygvwk5p6w6iyvfqfpvxbwjvi1b2cw-uv-0.11.16/share:/nix/store/1m05k7xgfnw6jc21xxk5681ni3ar97wf-pkg-config-wrapper-0.29.2/share:/nix/store/ilblcn1dkvzghcr2yk3av6jxn5rk1iqw-patchelf-0.15.2/share'
export XDG_DATA_DIRS
cmakeFlags=''
export cmakeFlags
out='/nix/store/p9k78clh5pgwsasmq9z256yrdpxah2j1-devenv-shell-env'
export out
...
'
outputMan='out'
PATH='/nix/store/cgjr3kj3hs7ngznyws5qfg16c8scpys0-bash-interactive-5.3p9/bin:/nix/store/g4k9vjiwikf7ys8qq15dypn12qwyivxc-python3-3.13.13-env/bin:/nix/store/hq1ygvwk5p6w6iyvfqfpvxbwjvi1b2cw-uv-0.11.16/bin:/nix/store/1bs97v1qsgd1vmjn0k9cl9qkxq04ngzp-pyright-1.1.410/bin:/nix/store/1m05k7xgfnw6jc21xxk5681ni3ar97wf-pkg-config-wrapper-0.29.2/bin:/nix/store/ilblcn1dkvzghcr2yk3av6jxn5rk1iqw-patchelf-0.15.2/bin:/nix/store/788mx070y81zjlg5ipcl0cra3afviw9k-gcc-wrapper-15.2.0/bin:/nix/store/qxaq7jz61a6zkr2mq49i0zvqip2m2jj8-gcc-15.2.0/bin:/nix/store/bsh7n2nx8ndmm1mmww6v2h4851nalj13-glibc-2.42-61-bin/bin:/nix/store/9ypz3flqsrl5xl495mm8h645gadjsxi1-coreutils-9.11/bin:/nix/store/mbyy19mdwnfvfwmdi0gqgggx0njvpl1w-binutils-wrapper-2.46/bin:/nix/store/s2946bl9ciwzhafd66jhansrmxq9xhqm-binutils-2.46/bin:/nix/store/9ypz3flqsrl5xl495mm8h645gadjsxi1-coreutils-9.11/bin:/nix/store/c1cjgg6p8m8fssivzrc2p13mwwml3p3v-findutils-4.10.0/bin:/nix/store/ww555mznia5v7sz2w85lblg4amvhkhv1-diffutils-3.12/bin:/nix/store/kgxafhycw2kybbqih759ykc2043qyi5j-gnused-4.9/bin:/nix/store/gn94gpcp5q08x4v6g8mvw8v4r65rcjzk-gnugrep-3.12/bin:/nix/store/wp1cshqv98i8abs8rcx91s54igqgll0f-gawk-5.4.0/bin:/nix/store/k5akwnrn9x2afaj2va7g4a2zpdim8l43-gnutar-1.35/bin:/nix/store/ndpbjk6jhw0da5h272dqqnyxa35a9gmx-gzip-1.14/bin:/nix/store/3y3kzc5njlj7nwj1s78am0yzjnpicv9x-bzip2-1.0.8-bin/bin:/nix/store/vlq7nnw39j7rwk0pp68w1fcwzpxahm9h-gnumake-4.4.1/bin:/nix/store/gik3rh1vz2jlgnifb9dh6vc6sxwwz9jj-bash-5.3p9/bin:/nix/store/wgvplwp0faqhqr92w0ma8bxaxk202ama-patch-2.8/bin:/nix/store/csra6zhdjw7rjzv98fycz7qjalyv55k2-xz-5.8.3-bin/bin:/nix/store/kyz3mm5snbb8998kbkm28jps1phk9509-file-5.47/bin'
export PATH
NIX_PYTHONPATH='/nix/store/v223818fhgwzmybccrf91ai7nzlb8fli-devenv-profile/lib/python3.13/site-packages'
export NIX_PYTHONPATH
declare -a postFixupHooks=('noBrokenSymlinksInAllOutputs' '_makeSymlinksRelative' '_multioutPropagateDev' )
doCheck=''
export doCheck
DEVENV_TASK_FILE='/nix/store/9i68xz45c3w5nsx91yxvc29n55jv3axc-tasks.json'
export DEVENV_TASK_FILE
OBJDUMP='objdump'
export OBJDUMP
declare -a pkgsBuildHost=('/nix/store/bvsy09r85z0q1m30p87s1bf4ikb0s84i-bash-interactive-5.3p9-dev' '/nix/store/cgjr3kj3hs7ngznyws5qfg16c8scpys0-bash-interactive-5.3p9' '/nix/store/g4k9vjiwikf7ys8qq15dypn12qwyivxc-python3-3.13.13-env' '/nix/store/hq1ygvwk5p6w6iyvfqfpvxbwjvi1b2cw-uv-0.11.16' '/nix/store/1bs97v1qsgd1vmjn0k9cl9qkxq04ngzp-pyright-1.1.410' '/nix/store/1m05k7xgfnw6jc21xxk5681ni3ar97wf-pkg-config-wrapper-0.29.2' '/nix/store/ilblcn1dkvzghcr2yk3av6jxn5rk1iqw-patchelf-0.15.2' '/nix/store/xknj6c33cc197s60ry0i69vdkmaizrs1-update-autotools-gnu-config-scripts-hook' '/nix/store/0y5xmdb7qfvimjwbq7ibg1xdgkgjwqng-no-broken-symlinks.sh' '/nix/store/cv1d7p48379km6a85h4zp6kr86brh32q-audit-tmpdir.sh' '/nix/store/85clx3b0xkdf58jn161iy80y5223ilbi-compress-man-pages.sh' '/nix/store/p3l1a5y7nllfyrjn2krlwgcc3z0cd3fq-make-symlinks-relative.sh' '/nix/store/5yzw0vhkyszf2d179m0qfkgxmp5wjjx4-move-docs.sh' '/nix/store/fyaryjvghbkpfnsyw97hb3lyb37s1pd6-move-lib64.sh' '/nix/store/kd4xwxjpjxi71jkm6ka0np72if9rm3y0-move-sbin.sh' '/nix/store/pag6l61paj1dc9sv15l7bm5c17xn5kyk-move-systemd-user-units.sh' '/nix/store/cmzya9irvxzlkh7lfy6i82gbp0saxqj3-multiple-outputs.sh' '/nix/store/x8c40nfigps493a07sdr2pm5s9j1cdc0-patch-shebangs.sh' '/nix/store/cickvswrvann041nqxb0rxilc46svw1n-prune-libtool-files.sh' '/nix/store/xyff06pkhki3qy1ls77w10s0v79c9il0-reproducible-builds.sh' '/nix/store/z7k98578dfzi6l3hsvbivzm7hfqlk0zc-set-source-date-epoch-to-latest.sh' '/nix/store/pilsssjjdxvdphlg2h19p0bfx5q0jzkn-strip.sh' '/nix/store/788mx070y81zjlg5ipcl0cra3afviw9k-gcc-wrapper-15.2.0' '/nix/store/mbyy19mdwnfvfwmdi0gqgggx0njvpl1w-binutils-wrapper-2.46' )
NIX_BINTOOLS_WRAPPER_TARGET_HOST_x86_64_unknown_linux_gnu='1'
export NIX_BINTOOLS_WRAPPER_TARGET_HOST_x86_64_unknown_linux_gnu
RANLIB='ranlib'
export RANLIB
NIX_CFLAGS_COMPILE=' -frandom-seed=p9k78clh5p -isystem /nix/store/bvsy09r85z0q1m30p87s1bf4ikb0s84i-bash-interactive-5.3p9-dev/include -isystem /nix/store/g4k9vjiwikf7ys8qq15dypn12qwyivxc-python3-3.13.13-env/include -isystem /nix/store/bvsy09r85z0q1m30p87s1bf4ikb0s84i-bash-interactive-5.3p9-dev/include -isystem /nix/store/g4k9vjiwikf7ys8qq15dypn12qwyivxc-python3-3.13.13-env/include'
...
depsHostHost=''
export depsHostHost
DEVENV_RUNTIME='/run/user/1000/devenv-0acc681'
...
DEVENV_DOTFILE='/home/renan/projects/assignments/tiqets/.devenv'
...
eval "${shellHook:-}"
